...
const invalideTriangle = getTriangle(1, 2, 3);
console.log(invalideTriangle);

console.log(invalideTriangle.perimeter);

console.log(invalideTriangle.area);

console.log(invalideTriangle.a, invalideTriangle.b);﻿
